...
if window:
    ...
    with mss() as sct:
        # Move OpenCV window out of the capture area
        display_window_name = "Albion Online Client"
        cv.namedWindow(display_window_name)
        cv.moveWindow(display_window_name, left + width + 10, top)  # Position it to the right of the capture area
